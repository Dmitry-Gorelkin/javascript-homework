...
// let ordered = 50;
// let messege;
// console.log(messege = ordered >= total ? "На складе недостаточно твоаров!" : "Заказ оформлен, с вами свяжется менеджер");
// ordered = 20;
// console.log(messege = ordered >= total ? "На складе недостаточно твоаров!" : "Заказ оформлен, с вами свяжется менеджер");
// ordered = 80;
// console.log(messege = ordered >= total ? "На складе недостаточно твоаров!" : "Заказ оформлен, с вами свяжется менеджер");
...
// const value = prompt('Введите кол-во дроидов');
// let totalPrice = 0;

// if (value === null) {
//     console.log('Отменено пользователем!');
// } else if (Number(value)) {
//     totalPrice = pricePerDroid * Number(value);
